var config = {
    ...
    "articleTypeNotFloatsOnFirstPage":["undefined","DEFAULT","ARCHIMEDES","EDITORIAL","RWDGTY","OLAEGLCDHH"
    ],
    ...
    "pageColumnDetails":{
        "LAYOUT1":{        
         ...
         "LAYOUT3":{
            "openerPageColumnDetails":[
                  {"width":360, "height":699.83,"floatsCited":false,"gutter":0}
                ],
                "columnDetails":[
                  {"width":360, "height":699.83,"floatsCited":false,"gutter":0}
                ],
   ...
   "replFonts":[
    ...
    "assignUsingXpath": {
       "toFrames":[
         ...
         {"xpath" : "//div[@class='MULTIMEDIASTMNT']", "frame-name":"MULTIMEDIASTMNT", "action":"move", "styleOverride":null},
          ...
          "ELDGTY":{
            ...
            "online":{
                "COLOR1":{
                    "colourType":"process",
                    "colourMode":"RGB",
                    "colourValue":"0,166,93"
                    },
                "COLOR2":{
                    "colourType":"process",
                    "colourMode":"RGB",
                    "colourValue":"192,219,198"
                    },
                 "COLOR3":{
                    "colourType":"process",
                    "colourMode":"RGB",
    ...
    "ARCHIMEDES":{
            ...
            "online":{
                "COLOR1":{
                    "colourType":"process",
                    "colourMode":"RGB",
                    "colourValue":"101,174,224"
                    },
                "COLOR2":{
                    "colourType":"process",
                    "colourMode":"RGB",
                    "colourValue":"231,238,248"
                    },
                 "COLOR3":{
                    "colourType":"process",
                    "colourMode":"RGB",
        ...
        "OLAEGLCDHH":{
            "print":{
                "COLOR1":{
                    "colourType":"process",
                    "colourMode":"CMYK",
                    "colourValue":"0,75,80,20"
                    },
                "COLOR2":{
                    "colourType":"process",
                    "colourMode":"CMYK",
                    "colourValue":"0,15,16,4"
                    },
                  "COLOR3":{
                    "colourType":"process",
                    "colourMode":"CMYK",
            ...
            "online":{
                "COLOR1":{
                    "colourType":"process",
                    "colourMode":"RGB",
                    "colourValue":"174,81,51"
                    },
                "COLOR2":{
                    "colourType":"process",
                    "colourMode":"RGB",
                    "colourValue":"239,220,214"
                    },
                 "COLOR3":{
                    "colourType":"process",
                    "colourMode":"RGB",

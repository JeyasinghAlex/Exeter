...
<xsl:template match = "//b//b|//strong//strong|//strong//b|//b//strong|//sub//sub|//sup//sup|//sc//sc">
          <xsl:apply-templates/>        
</xsl:template>
...
<xsl:template match="//img">
    <xsl:choose>
        ...
        <xsl:when test="parent::p[@class='jrnlSecPara'] or ancestor::p[@class='jrnlTblFoot'] or ancestor::p[@class='jrnlTblBody']">
            <matchEqn>
                <xsl:choose>
                    <xsl:when test="not(@data-eq-depth = 0)">
                        <xsl:attribute name="cstyle"  select="concat('jrnlMathBaselineShift_',@data-eq-depth)" />

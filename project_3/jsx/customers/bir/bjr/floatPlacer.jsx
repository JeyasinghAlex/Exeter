...
var floatPlacer = function() {
    ...
    config["currDocDOM"] = config["currDoc"].xmlElements[0].evaluateXPathExpression(domXpath)[0];//appending document DOM object to config
...
//~                     currPageFrame = currPage.textFrames.itemByName("VERSO");
                ...
                if (currPageFrame.isValid){//checking whether the page has text frames for alignment
                    ...
                    if (!(currPageFrame.nextTextFrame == null)){
                        ...
                        else if (!nextFrameIsValid && (config.inlineTableContinuedUptoPage != currPage.name)){//this is second case
                                nextFrameIsValid = true;
                            }//end of ELSE IF
                        }//end of IF
                    //=====================================

var config = {
    ...
    "geoBoundsVerso":[72,63,651,423
    ],
    "geoBoundsRecto":[72,585,651,945
    ],
    "articleTypeDetails":{
    "undefined":"LAYOUT1",
    "DEFAULT":"LAYOUT1",
    ...
    "pageColumnDetails":{
        "LAYOUT1":{        
            "openerPageColumnDetails":[
                  {"width":360, "height":563.08,"floatsCited":false,"gutter":0}
                ],
                "columnDetails":[
                  {"width":360, "height":579,"floatsCited":false,"gutter":0},
                ],
                "openerPageMargin":{
                 "top":68,
                "bottom":89,
...
//~        "continuedText":"Table [ID].[emsp](<i>Continued</i>)",
   ...
   "replFonts":[
            {"fontFamily":"ITC Leawood", "fontStyle":"Roman"},
            {"fontFamily":"ITC Leawood", "fontStyle":"Italic"},
            {"fontFamily":"ITC Leawood", "fontStyle":"Bold"},
            {"fontFamily":"ITC Leawood", "fontStyle":"Bold Italic"},
            {"fontFamily":"Goudy", "fontStyle":"Old Style"},
    ...
    "assignUsingXpath": {
       "toFrames":[
         ...
         {"xpath" : "//p[@pstyle='jrnlCRTL']", "frame-name":"CRTL", "action":"move", "styleOverride":null},

alignStubFramesToAbsHead(myDoc, 'STUB_COLUMN', 'jrnlAbsBoxedText|jrnlAbsHead|jrnlAbsPara|jrnlHead1_First|TXT_CHAP_FIRST|QUOTE-O_WITH_ATTRIB|QUOTE-O', 'ascent');
addNonBreakSpBeforeEmail("//span[@class='jrnlCorrAff'][not(ancestor::div[@class='sub-article'])] | //span[@class='jrnlCorrEmail'][not(ancestor::div[@class='sub-article'])] |//span[@class='jrnlEmail'][not(ancestor::div[@class='sub-article'])]");

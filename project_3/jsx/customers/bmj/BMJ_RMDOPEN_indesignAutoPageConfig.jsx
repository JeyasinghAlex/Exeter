var config = {
    ...
    "geoBoundsVerso":[48.5,42,739.300787401575,553.275590551181
    ],
    "geoBoundsRecto":[48.5,637.334645669291,739.3,1148.62204724409
    ],
    "articleTypeDetails":{
    "undefined":"LAYOUT1",
    ...
    "pageColumnDetails":{
        "LAYOUT1":{
               "openerPageColumnDetails":[
                  {"width":196.928, "height":691.056,"floatsCited":false,"gutter":0},
                  {"width":196.928, "height":691.056,"floatsCited":false,"gutter":12.5}
                ],
                "columnDetails":[
                  {"width":246.388, "height":690.8,"floatsCited":false,"gutter":0},
                  {"width":246.388, "height":690.8,"floatsCited":false,"gutter":18.5}
                ],
               "openerPageMargin":{
               "top":52,
                "bottom":50.7,
         ...
         "LAYOUT2":{
            "openerPageColumnDetails":[
                  {"width":362.179, "height":690.8,"floatsCited":false,"gutter":0}
                ],
                "columnDetails":[
                  {"width":362.179, "height":690.8,"floatsCited":false,"gutter":0}
                ],
         ...
         "LAYOUT3":{
            "openerPageColumnDetails":[
                  {"width":118.444, "height":690.8,"floatsCited":false,"gutter":0},
                  {"width":118.444, "height":690.8,"floatsCited":false,"gutter":12.5},
                  {"width":118.444, "height":690.8,"floatsCited":false,"gutter":12.5},
                  {"width":118.444, "height":690.8,"floatsCited":false,"gutter":12.5}
                ],
                "columnDetails":[
        ...
        "undefined":{
            "print":{
                "COLOR1":{
                    "colourType":"process",
                    "colourMode":"CMYK",
                    "colourValue":"100,30,85,20"
                    },
                "COLOR2":{
                    "colourType":"process",
                    "colourMode":"CMYK",
                    "colourValue":"20,02,17,04"
                    },
                "HYPERLINK":{
                    "colourType":"process",
                    "colourMode":"CMYK",
            ...
            "online":{
                "COLOR1":{
                    "colourType":"process",
                    "colourMode":"RGB",
                    "colourValue":"0,122,75"
                    },
                "COLOR2":{
                    "colourType":"process",
                    "colourMode":"RGB",
                    "colourValue":"194,210,201"
                    },
                "HYPERLINK":{
                    "colourType":"process",
                    "colourMode":"RGB",

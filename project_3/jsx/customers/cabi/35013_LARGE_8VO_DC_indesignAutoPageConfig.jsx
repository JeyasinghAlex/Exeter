var config = {
    ...
    "geoBoundsVerso":[72,55.559,639.380543307087,427.55905511811
    ],
    "geoBoundsRecto":[72,547.55905511811,639.380543307087,919.55911023622
    ],
    "articleTypeDetails":{
    "undefined":"LAYOUT1",
    "DNQS":"LAYOUT2"
    ...
    "pageColumnDetails":{
        "LAYOUT1":{        
            "openerPageColumnDetails":[
                  {"width":180, "height":515.638,"floatsCited":false,"gutter":0},
                  {"width":180, "height":515.638,"floatsCited":false,"gutter":12}
              
                ],
                "columnDetails":[
                  {"width":180, "height":567.381,"floatsCited":false,"gutter":0},
                  {"width":180, "height":567.381,"floatsCited":false,"gutter":12}
...
"continuedStyle":{
    ...
    "adjustParagraphSpaceStyleList":{
        "increase":{
            "before":"jrnlHead1,jrnlHead1_First,jrnlHead2,jrnlHead3,jrnlRefHead,BL-T,NL-T,BL-O,NL-O,QUOTE-T,QUOTE-O_WITH_ATTRIB",
            "after":"BL-B,NL-B,BL-O,NL-O,QUOTE-O,QUOTE-B,jrnlBlockQuoteAttrib"
         },
        "decrease":{
            "before":"jrnlHead1_First,jrnlHead1,jrnlHead2,jrnlRefHead,BL-T,NL-T,BL-O,NL-O,QUOTE-T,QUOTE-O_WITH_ATTRIB",
            "after":"BL-B,NL-B,BL-O,NL-O,QUOTE-O,QUOTE-B,jrnlBlockQuoteAttrib"
         },
    ...
    "firstPageFrameOnBottomXpath": "//div[@class='jrnlCorrespBlock']",
    "assignUsingXpath": {
       "toFrames":[
         ...
         "undefined":{
            "print":{
                "COLOR1":{
                    "colourType":"process",
                    "colourMode":"CMYK",
                    "colourValue":"67,100,4,5"
                    },
                "COLOR2":{
                    "colourType":"process",
                    "colourMode":"CMYK",
                    "colourValue":"13,20,1,1"
                    },
                "HYPERLINK":{
                    "colourType":"process",
                    "colourMode":"CMYK",
            ...
            "online":{
                "COLOR1":{
                    "colourType":"process",
                    "colourMode":"RGB",
                    "colourValue":"109,32,119"
                    },
                "COLOR2":{
                    "colourType":"process",
                    "colourMode":"RGB",
                    "colourValue":"226,210,228"
                    },
                 "HYPERLINK":{
                    "colourType":"process",
                    "colourMode":"RGB",
        ...
        "DNQS":{
            "print":{
                "COLOR1":{
                    "colourType":"process",
                    "colourMode":"CMYK",
                    "colourValue":"68,34,0,0"
                    },
                "COLOR2":{
                    "colourType":"process",
                    "colourMode":"CMYK",
                    "colourValue":"11,5,0,0"
                    },
                "HYPERLINK":{
                    "colourType":"process",
                    "colourMode":"CMYK",
            ...
            "online":{
                "COLOR1":{
                    "colourType":"process",
                    "colourMode":"RGB",
                    "colourValue":"65,143,222"
                    },
                "COLOR2":{
                    "colourType":"process",
                    "colourMode":"RGB",
                    "colourValue":"227,238,250"
                    },
                 "HYPERLINK":{
                    "colourType":"process",
                    "colourMode":"RGB",
    ...
    "tableSetter" :{
            "thead": {
                "css" : {
                 ...
                 "fontPath"  : "HelveticaNeueLTStd/HelveticaNeueLTStd-Roman.otf",
                "align" : "left",
                "valign": "bottom"
            },
            "tbody":{
 ...
 "runOnSectionsOrArticles":[
        {"xpath":"//div[@class='jrnlRefGroup']",
            ...
            "columnDetails":{        
                "openerPageColumnDetails":[
                  {"width":372, "height":360,"floatsCited":false,"gutter":0}
                ],
                "columnDetails":[
                  {"width":372, "height":567.381,"floatsCited":false,"gutter":0},
        ...
        {"xpath":"//div[@class='jrnlAckBlockGroup']",
            "continueType":"samePage",
            "spaceAbove":30,
            "firstbaselineOffset":1296135023,
            "columnDetails":{        

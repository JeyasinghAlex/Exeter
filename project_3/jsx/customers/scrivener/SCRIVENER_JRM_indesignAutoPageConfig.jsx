var config = {
    ...
    "geoBoundsVerso":[72,45,727.659,549
    ],
    "geoBoundsRecto":[72,675,727.659,1179
    ],
    "articleTypeDetails":{
    "undefined":"LAYOUT1",
    "DEFAULT":"LAYOUT1"
    ...
    "pageColumnDetails":{
        "LAYOUT1":{        
            "openerPageColumnDetails":[
                  {"width":238.5, "height":631.659,"floatsCited":false,"gutter":0},
                  {"width":238.5, "height":631.659,"floatsCited":false,"gutter":27}
                ],
                "columnDetails":[
                  {"width":238.5, "height":655.659,"floatsCited":false,"gutter":0},
                  {"width":238.5, "height":655.659,"floatsCited":false,"gutter":27}
                ],
                "openerPageMargin":{
                 "top":96,
                "bottom":64.341,
    ...
    "assignUsingXpath": {
       "toFrames":[
         {"xpath" : "//div[@class='jrnlStubBlock']", "frame-name":"STUB_COLUMN", "action":"move", "styleOverride":null},
          {"xpath" : "//p[@pstyle='jrnlDOI']", "frame-name":"DOI", "action":"move", "styleOverride":null},
         ...
         {"xpath" : "//p[@pstyle='jrnlTVTR']", "frame-name":"TVTR", "action":"move", "styleOverride":null},
          {"xpath" : "//p[@pstyle='jrnlTRTL']", "frame-name":"TRTL", "action":"move", "styleOverride":null},

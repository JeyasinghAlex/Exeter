...
<xsl:template match="//div[@class='WordSection1']/div[@class='front']|//div[@class='WordSection1']/div[@class='body']|//div[@class='WordSection1']/div[@class='back']|div[@id='queryDivNode']">
    <xsl:choose>
        <xsl:when test=".=''"/>
        <xsl:otherwise>
          <xsl:copy>
...
<xsl:template match="//div[@class='floatBlock']">
    <floatBlock>
            <xsl:apply-templates select="@* | node()"/>
    </floatBlock>
</xsl:template>
...
<xsl:template match="//div[@class='jrnlVidBlock']">
    <xsl:choose>
        ...
        <xsl:otherwise>
        <div>
            <!--The below changes are made on 01-Sep-2017 to switch to new Place Floats UI-->
            <xsl:if test="not(@data-position) and not(@data-column-start) and @data-float-placement">
                    <xsl:choose>
                        <xsl:when test="@data-float-placement = 'SingleColumn'">
                            <xsl:attribute name="data-column-span"><xsl:text>0</xsl:text></xsl:attribute>
                        </xsl:when>
                        <xsl:when test="@data-float-placement = 'DoubleColumn'">
                            <xsl:attribute name="data-column-span"><xsl:text>1</xsl:text></xsl:attribute>
                        </xsl:when>
                        <xsl:when test="@data-float-placement = 'TopLeft'">
                            <xsl:attribute name="data-position"><xsl:text>top</xsl:text></xsl:attribute>
                            <xsl:attribute name="data-column-start"><xsl:text>0</xsl:text></xsl:attribute>
                        </xsl:when>
                        <xsl:when test="@data-float-placement = 'TopMarginalColumn'">
                            <xsl:attribute name="data-position"><xsl:text>top</xsl:text></xsl:attribute>
                            <xsl:attribute name="data-column-start"><xsl:text>0</xsl:text></xsl:attribute>
                        </xsl:when>
                        <xsl:when test="@data-float-placement = 'TopSingleColumn'">
                            <xsl:attribute name="data-position"><xsl:text>top</xsl:text></xsl:attribute>
                            <xsl:attribute name="data-column-start"><xsl:text>0</xsl:text></xsl:attribute>
                        </xsl:when>
                        <xsl:when test="@data-float-placement = 'TopDoubleColumn'">
                            <xsl:attribute name="data-position"><xsl:text>top</xsl:text></xsl:attribute>
                            <xsl:attribute name="data-column-start"><xsl:text>0</xsl:text></xsl:attribute>
                        </xsl:when>
                        <xsl:when test="@data-float-placement = 'MarginalTopLeft'">
                            <xsl:attribute name="data-position"><xsl:text>top</xsl:text></xsl:attribute>
                            <xsl:attribute name="data-column-start"><xsl:text>0</xsl:text></xsl:attribute>
                        </xsl:when>
                        <xsl:when test="@data-float-placement = 'BottomLeft'">
                            <xsl:attribute name="data-position"><xsl:text>bottom</xsl:text></xsl:attribute>
                            <xsl:attribute name="data-column-start"><xsl:text>0</xsl:text></xsl:attribute>
                        </xsl:when>
                        <xsl:when test="@data-float-placement = 'BottomDoubleColumn'">
                            <xsl:attribute name="data-position"><xsl:text>bottom</xsl:text></xsl:attribute>
                            <xsl:attribute name="data-column-start"><xsl:text>0</xsl:text></xsl:attribute>
                        </xsl:when>
                        <xsl:when test="@data-float-placement = 'BottomMarginalColumn'">
                            <xsl:attribute name="data-position"><xsl:text>bottom</xsl:text></xsl:attribute>
                            <xsl:attribute name="data-column-start"><xsl:text>0</xsl:text></xsl:attribute>
                        </xsl:when>
                        <xsl:when test="@data-float-placement = 'MarginalBottomLeft'">
                            <xsl:attribute name="data-position"><xsl:text>bottom</xsl:text></xsl:attribute>
                            <xsl:attribute name="data-column-start"><xsl:text>0</xsl:text></xsl:attribute>
                        </xsl:when>
                        <xsl:when test="@data-float-placement = 'TopRight'">
                            <xsl:attribute name="data-position"><xsl:text>top</xsl:text></xsl:attribute>
                            <xsl:attribute name="data-column-start"><xsl:text>1</xsl:text></xsl:attribute>
                        </xsl:when>
                        <xsl:when test="@data-float-placement = 'ThirdTop'">
                            <xsl:attribute name="data-position"><xsl:text>top</xsl:text></xsl:attribute>
                            <xsl:attribute name="data-column-start"><xsl:text>2</xsl:text></xsl:attribute>
                        </xsl:when>
                        <xsl:when test="@data-float-placement = 'BottomRight'">
                            <xsl:attribute name="data-position"><xsl:text>bottom</xsl:text></xsl:attribute>
                            <xsl:attribute name="data-column-start"><xsl:text>1</xsl:text></xsl:attribute>
                        </xsl:when>
                        <xsl:when test="@data-float-placement = 'ThirdBottom'">
                            <xsl:attribute name="data-position"><xsl:text>bottom</xsl:text></xsl:attribute>
                            <xsl:attribute name="data-column-start"><xsl:text>2</xsl:text></xsl:attribute>
                        </xsl:when>
                        <xsl:otherwise>
            ...
            <xsl:if test="not(@data-override-page) and @data-page-num">
                    <xsl:attribute name="data-override-page" select="@data-page-num"/>
            </xsl:if>
            <xsl:if test="not(@data-width-factor) and @data-float-percent">
                    <xsl:attribute name="data-width-factor" select="@data-float-percent"/>
            </xsl:if>
            <!---->
            <xsl:apply-templates select="@* | node()"/>
        </div>
...
<xsl:template match="//div[@class='jrnlVerseGroup']">
            <xsl:apply-templates/>
</xsl:template>
<!---->
<xsl:template match="//div[@class='jrnlAppGroup']">
        <div>
            <xsl:apply-templates select="@* | node()"/>
        </div>
...
<xsl:template match="//div[@class='jrnlRefGroup']">
        <div>
            <xsl:apply-templates select="@* | node()"/>
        </div>
            <xsl:if test="not(following-sibling::*)">
...
<xsl:if test="@class">
   ...
   <xsl:variable name="nodeName">
      ...
      <xsl:variable name="StyleName">
        ...
        <xsl:if test="$className = 'jrnlSecPara'">
            ...
            <xsl:choose>
               ...
               <xsl:when test="preceding-sibling::*[1][@class='jrnlEqnPara']">
                  <xsl:text>TXT_AFTER_EQN</xsl:text>
               </xsl:when>			
               ...
               <xsl:when test="$precedingNodeClassName = 'jrnlVerseLine' ">
                  <xsl:text>TXT_AFTER_POEM</xsl:text>
               </xsl:when>   			
               <xsl:otherwise>
        ...
        <xsl:if test="$className = 'jrnlPara'">
            <xsl:if test="ancestor::div[@class='body']/preceding-sibling::div[@class='front']/@prefix">
                    <xsl:value-of select="./ancestor::div[@class='body']/preceding-sibling::div[@class='front']/@prefix"/><xsl:text>_</xsl:text>
            </xsl:if>
            <xsl:choose>
               ...
               <xsl:when test="$precedingNodeClassName = 'jrnlSecParaAuthors' or $precedingNodeClassName = 'jrnlAppHead1' or $precedingNodeClassName = 'jrnlAppHead2' or $precedingNodeClassName = 'jrnlAppHead3' or $precedingNodeClassName = 'jrnlAppHead4' or @data-no-indent='true'">
                  <xsl:text>jrnlPara_TXT</xsl:text>
               </xsl:when>
               <xsl:when test="$precedingNodeClassName = 'jrnlBlockQuote' or $precedingNodeClassName = 'jrnlExtract'" >
                  <xsl:text>jrnlPara_TXT_CONT</xsl:text>
               </xsl:when>   			
               <xsl:when test="$precedingNodeClassName = 'jrnlTblBlock' or $precedingNodeClassName = 'jrnlFigBlock'">
                  <xsl:text>jrnlPara_TXI</xsl:text>
               </xsl:when>   			
               <xsl:when test="preceding-sibling::*[1][name()='ol'] or preceding-sibling::*[1][name()='ul'] ">
                  <xsl:text>jrnlPara_TXT_AFTER_LIST</xsl:text>
               </xsl:when>   			
               <xsl:when test="$precedingNodeClassName = 'jrnlVerseLine' ">
                  <xsl:text>jrnlPara_TXT_AFTER_POEM</xsl:text>
               </xsl:when>   			
               <!--<xsl:when test="preceding-sibling::*[1][@class='jrnlEqnPara']">
                  <xsl:text>TXT_AFTER_EQN</xsl:text>
               </xsl:when>   -->			
               <xsl:otherwise>
                  <xsl:text>jrnlPara_TXI</xsl:text><!--<xsl:text>TXI</xsl:text>-->
               </xsl:otherwise>								
            </xsl:choose>
         </xsl:if>   
        ...
        <xsl:if test="$className = 'jrnlAbsPara'">
            ...
            <xsl:choose>
               <xsl:when test="not(following-sibling::*[1]) and not(ancestor::div[@class='front']/following-sibling::div[@class='body']) and not(ancestor::div[@class='front']/following-sibling::div[@class='back'])">
                  <xsl:text>jrnlAbsPara_NBM</xsl:text>
               </xsl:when>
               <xsl:when test="not(following-sibling::*[1]) and not(ancestor::div[@class='front']/following-sibling::div[@class='body'])">
        ...
        <xsl:if test="$className = 'jrnlAppHead2'">
            ...
            <xsl:choose>
               <xsl:when test="preceding-sibling::*[1][name() = 'ol']">
                  <xsl:text>jrnlAppHead2_After_OL</xsl:text>
               </xsl:when>
               <xsl:when test="preceding-sibling::*[1][name() = 'ul']">
                  <xsl:text>jrnlAppHead2_After_UL</xsl:text>
               </xsl:when>
               <xsl:when test="$precedingNodeClassName = 'jrnlAppHead1'">
                  <xsl:text>jrnlAppHead2_H1</xsl:text>
               </xsl:when>
               <xsl:otherwise>
                  <xsl:text>jrnlAppHead2</xsl:text><!--<xsl:text>TXI</xsl:text>-->
               </xsl:otherwise>								
            </xsl:choose>
         </xsl:if>   
        ...
        <xsl:if test="$className = 'jrnlAppHead3'">
            <xsl:variable name="precedingNodeClassName" select="preceding-sibling::*[1]/@class"/>
            <xsl:if test="ancestor::div[@class='WordSection1']//div[@class='front']/@prefix">
                    <xsl:value-of select="./ancestor::div[@class='WordSection1']//div[@class='front']/@prefix"/><xsl:text>_</xsl:text>
            </xsl:if>
            <xsl:choose>
               <xsl:when test="preceding-sibling::*[1][name() = 'ol']">
                  <xsl:text>jrnlAppHead3_After_OL</xsl:text>
               </xsl:when>
               <xsl:when test="preceding-sibling::*[1][name() = 'ul']">
                  <xsl:text>jrnlAppHead3_After_UL</xsl:text>
               </xsl:when>
               <xsl:when test="$precedingNodeClassName = 'jrnlAppHead2'">
                  <xsl:text>jrnlAppHead3_H2</xsl:text>
               </xsl:when>
               <xsl:otherwise>
                  <xsl:text>jrnlAppHead3</xsl:text>
               </xsl:otherwise>								
            </xsl:choose>
         </xsl:if>   
        ...
        <xsl:if test="$className = 'jrnlAppHead4'">
            <xsl:variable name="precedingNodeClassName" select="preceding-sibling::*[1]/@class"/>
            <xsl:if test="ancestor::div[@class='WordSection1']//div[@class='front']/@prefix">
                    <xsl:value-of select="./ancestor::div[@class='WordSection1']//div[@class='front']/@prefix"/><xsl:text>_</xsl:text>
            </xsl:if>
            <xsl:choose>
               <xsl:when test="preceding-sibling::*[1][name() = 'ol']">
                  <xsl:text>jrnlAppHead4_After_OL</xsl:text>
               </xsl:when>
               <xsl:when test="preceding-sibling::*[1][name() = 'ul']">
                  <xsl:text>jrnlAppHead4_After_UL</xsl:text>
               </xsl:when>
               <xsl:when test="$precedingNodeClassName = 'jrnlAppHead3'">
                  <xsl:text>jrnlAppHead4_H3</xsl:text>
               </xsl:when>
               <xsl:otherwise>
                  <xsl:text>jrnlAppHead4</xsl:text>
               </xsl:otherwise>								
            </xsl:choose>
         </xsl:if>   
        ...
        <xsl:if test="$className = 'jrnlAuthor'">
            <xsl:choose>
                <xsl:when test="parent::div[@class='jrnlAuthorGroup']/following-sibling::div[@class='jrnlAuthorGroup'] and not(parent::div[@class='jrnlAuthorGroup']/preceding-sibling::div[@class='jrnlAuthorGroup'])">
                    <xsl:text>jrnlAuthor_First</xsl:text>
                </xsl:when>
                <xsl:when test="not(following-sibling::p[@class='jrnlAff'])">
                    <xsl:text>jrnlAuthor_NO_Aff</xsl:text>
                </xsl:when>
               <xsl:otherwise>
                  <xsl:text>jrnlAuthor</xsl:text>
               </xsl:otherwise>								
            </xsl:choose>
         </xsl:if>   
        ...
        <xsl:if test="$className = 'jrnlHandlingEditorFN'">
            <xsl:choose>
                <xsl:when test="@data-prefix">
                        <xsl:value-of select="./@data-prefix"/><xsl:text>_</xsl:text>
                        <xsl:text>jrnlHandlingEditorFN</xsl:text>
                </xsl:when>
               <xsl:otherwise>
                  <xsl:text>jrnlHandlingEditorFN</xsl:text>
               </xsl:otherwise>								
        ...
        <xsl:if test="$className = 'jrnlAff'">
            ...
            <xsl:if test="parent::div[@data-prefix]">
                <xsl:value-of select="./parent::div[@data-prefix]/@data-prefix"/>
                <xsl:text>_</xsl:text>
            </xsl:if>
            <xsl:choose>
               <xsl:when test="ancestor::jrnlTitlePage">
        ...
        <xsl:if test="$className = 'jrnlCoAuthorFN'">
            <xsl:choose>
               <xsl:when test="not(preceding-sibling::*[1][@class='jrnlCoAuthorFN'])">
                  <xsl:text>jrnlCoAuthorFN</xsl:text>
               </xsl:when>   			
               <xsl:otherwise>
                  <xsl:text>jrnlCoAuthorFN-B</xsl:text>
               </xsl:otherwise>   			            
            </xsl:choose>
        </xsl:if>
        ...
        <xsl:if test="$className = 'jrnlBlockQuoteAttrib'">
            <xsl:choose>
               <xsl:when test="following-sibling::*[1][@class='jrnlBlockQuote']">
                  <xsl:text>jrnlBlockQuoteAttribStack</xsl:text>
               </xsl:when>   			
               <xsl:otherwise>
                  <xsl:text>jrnlBlockQuoteAttrib</xsl:text>
               </xsl:otherwise>   			            
            </xsl:choose>
        </xsl:if>
        <xsl:if test="$className = 'jrnlBlockQuote'">
            ...
            <xsl:choose>
               ...
               <xsl:when test="following-sibling::*[1][@class='jrnlBlockQuoteAttrib'] and not(preceding-sibling::*[1][@class='jrnlBlockQuote']) and not(following-sibling::*[1][@class='jrnlBlockQuote']) and (preceding-sibling::*[1][@class='jrnlHead1'] or preceding-sibling::*[1][@class='jrnlHead2'] or preceding-sibling::*[1][@class='jrnlHead3'] or preceding-sibling::*[1][@class='jrnlHead4'] or preceding-sibling::*[1][@class='jrnlHead5'] or preceding-sibling::*[1][@class='jrnlHead6'] or preceding-sibling::*[1][@class='jrnlRefHead'] or preceding-sibling::*[1][@class='jrnlAckHead'])">
                  <xsl:text>QUOTE-O-AFTER-HEAD_WITH_ATTRIB</xsl:text>
               </xsl:when>   			
               ...
               <xsl:when test="following-sibling::*[1][@class='jrnlBlockQuoteAttrib'] and not(preceding-sibling::*[1][@class='jrnlBlockQuote']) and not(following-sibling::*[1][@class='jrnlBlockQuote'])">
                  <xsl:text>QUOTE-O_WITH_ATTRIB</xsl:text>
               </xsl:when>   			
               ...
               <xsl:when test="following-sibling::*[1][@class='jrnlBlockQuoteAttrib'] and preceding-sibling::*[1][@class='jrnlBlockQuote'] and not(following-sibling::*[1][@class='jrnlBlockQuote']) and not(following-sibling::*[1][@class='jrnlHead1']) and not(following-sibling::*[1][@class='jrnlHead2']) and not(following-sibling::*[1][@class='jrnlHead3']) and not(following-sibling::*[1][@class='jrnlHead4']) and not(following-sibling::*[1][@class='jrnlHead5']) and not(following-sibling::*[1][@class='jrnlHead6']) and not(following-sibling::*[1][@class='jrnlRefHead']) and not(following-sibling::*[1][@class='jrnlAckHead'])">
                  <xsl:text>QUOTE_WITH_ATTRIB</xsl:text>
               </xsl:when>   			
        ...
        <xsl:if test="$className = 'jrnlVerseLine'">
            <xsl:if test="parent::div[@class='jrnlBoxBlock']">
                <xsl:text>BOX_</xsl:text>
            </xsl:if>
            <xsl:if test="ancestor::div[@class='jrnlTblBlock']">
            ...
            <xsl:choose>
               ...
               <xsl:when test="(preceding-sibling::*[1][@class='jrnlHead1']) or (preceding-sibling::*[1][@class='jrnlHead2']) or (preceding-sibling::*[1][@class='jrnlHead3']) or (preceding-sibling::*[1][@class='jrnlHead4']) and following-sibling::*[1][@class='jrnlVerseLine']">
                  <xsl:text>POEM-SPL-NO_SPACE</xsl:text>
               </xsl:when>   			
               <xsl:when test="(preceding-sibling::*[1][@class='jrnlHead1']) or (preceding-sibling::*[1][@class='jrnlHead2']) or (preceding-sibling::*[1][@class='jrnlHead3']) or (preceding-sibling::*[1][@class='jrnlHead4']) and not(following-sibling::*[1][@class='jrnlVerseLine'])">
                  <xsl:text>POEM-SPL</xsl:text>
               </xsl:when>   			
               <xsl:when test="following-sibling::*[1][@class='jrnlVerseLineAttrib'] and not(preceding-sibling::*[1][@class='jrnlVerseLine']) and not(following-sibling::*[1][@class='jrnlVerseLine']) and (preceding-sibling::*[1][@class='jrnlHead1'] or preceding-sibling::*[1][@class='jrnlHead2'] or preceding-sibling::*[1][@class='jrnlHead3'] or preceding-sibling::*[1][@class='jrnlHead4'] or preceding-sibling::*[1][@class='jrnlHead5'] or preceding-sibling::*[1][@class='jrnlHead6'] or preceding-sibling::*[1][@class='jrnlRefHead'] or preceding-sibling::*[1][@class='jrnlAckHead'])">
                  <xsl:text>POEM-O-AFTER-HEAD_WITH_ATTRIB</xsl:text>
               </xsl:when>   			
               <xsl:when test="not(preceding-sibling::*[1][@class='jrnlVerseLine']) and not(following-sibling::*[1][@class='jrnlVerseLine']) and (preceding-sibling::*[1][@class='jrnlHead1'] or preceding-sibling::*[1][@class='jrnlHead2'] or preceding-sibling::*[1][@class='jrnlHead3'] or preceding-sibling::*[1][@class='jrnlHead4'] or preceding-sibling::*[1][@class='jrnlHead5'] or preceding-sibling::*[1][@class='jrnlHead6'] or preceding-sibling::*[1][@class='jrnlRefHead'] or preceding-sibling::*[1][@class='jrnlAckHead'])">
                  <xsl:text>POEM-O-AFTER-HEAD</xsl:text>
               </xsl:when>   			
               <xsl:when test="not(preceding-sibling::*[1][@class='jrnlVerseLine']) and not(following-sibling::*[1][@class='jrnlVerseLine'])">
                  <xsl:text>POEM-O</xsl:text>
               </xsl:when>   			
               <xsl:when test="not(preceding-sibling::*[1][@class='jrnlVerseLine']) and following-sibling::*[1][@class='jrnlVerseLine'] and (parent::div[@class='jrnlVerseGroup']//preceding-sibling::*[1][@class='jrnlVerseGroup'])">
                  <xsl:text>POEM-T_STACK</xsl:text>
               </xsl:when>   			
               <xsl:when test="not(preceding-sibling::*[1][@class='jrnlVerseLine']) and following-sibling::*[1][@class='jrnlVerseLine']">
                  <xsl:text>POEM-T</xsl:text>
               </xsl:when>   			
               <xsl:when test="following-sibling::*[1][@class='jrnlHead1'] or following-sibling::*[1][@class='jrnlHead2'] or following-sibling::*[1][@class='jrnlHead3'] or following-sibling::*[1][@class='jrnlHead4'] or following-sibling::*[1][@class='jrnlHead5'] or following-sibling::*[1][@class='jrnlHead6'] or following-sibling::*[1][@class='jrnlRefHead'] or following-sibling::*[1][@class='jrnlAckHead']">
                  <xsl:text>POEM-BEFORE-HEAD</xsl:text>
               </xsl:when>   			
               <xsl:when test="following-sibling::*[1][@class='jrnlVerseLineAttrib'] and preceding-sibling::*[1][@class='jrnlVerseLine'] and not(following-sibling::*[1][@class='jrnlVerseLine']) and not(following-sibling::*[1][@class='jrnlHead1']) and not(following-sibling::*[1][@class='jrnlHead2']) and not(following-sibling::*[1][@class='jrnlHead3']) and not(following-sibling::*[1][@class='jrnlHead4']) and not(following-sibling::*[1][@class='jrnlHead5']) and not(following-sibling::*[1][@class='jrnlHead6']) and not(following-sibling::*[1][@class='jrnlRefHead']) and not(following-sibling::*[1][@class='jrnlAckHead'])">
                  <xsl:text>POEM_WITH_ATTRIB</xsl:text>
               </xsl:when>   			
               <xsl:when test="preceding-sibling::*[1][@class='jrnlVerseLine'] and not(following-sibling::*[1][@class='jrnlVerseLine']) and not(following-sibling::*[1][@class='jrnlHead1']) and not(following-sibling::*[1][@class='jrnlHead2']) and not(following-sibling::*[1][@class='jrnlHead3']) and not(following-sibling::*[1][@class='jrnlHead4']) and not(following-sibling::*[1][@class='jrnlHead5']) and not(following-sibling::*[1][@class='jrnlHead6']) and not(following-sibling::*[1][@class='jrnlRefHead']) and not(following-sibling::*[1][@class='jrnlAckHead'])">
                  <xsl:text>POEM-B</xsl:text>
               </xsl:when>   			
               <xsl:otherwise>
        ...
        <xsl:if test="$className = 'jrnlBoxBlockDOI'">
            <xsl:choose>
               <xsl:when test ="count(./following-sibling::*)=0">
                    <xsl:text>jrnlBoxBlockDOI_Last</xsl:text>
               </xsl:when>
               <xsl:otherwise>
                  <xsl:text>jrnlBoxBlockDOI</xsl:text>
               </xsl:otherwise>								
            </xsl:choose>
        </xsl:if>
        <xsl:if test="$className = 'jrnlVidBlockDOI'">
            <xsl:choose>
               <xsl:when test ="count(./following-sibling::*)=0">
                    <xsl:text>jrnlVidBlockDOI_Last</xsl:text>
               </xsl:when>
               <xsl:otherwise>
                  <xsl:text>jrnlVidBlockDOI</xsl:text>
               </xsl:otherwise>								
            </xsl:choose>
        </xsl:if>
        <xsl:if test="$className = 'jrnlFigBlockDOI'">
            <xsl:choose>
               <xsl:when test ="count(./following-sibling::*)=0">
                    <xsl:text>jrnlFigBlockDOI_Last</xsl:text>
               </xsl:when>
               <xsl:otherwise>
                  <xsl:text>jrnlFigBlockDOI</xsl:text>
               </xsl:otherwise>								
            </xsl:choose>
        </xsl:if>
        <xsl:if test="$className = 'jrnlTblBlockDOI'">
            <xsl:choose>
               <xsl:when test ="count(./following-sibling::*)=0">
                    <xsl:text>jrnlTblBlockDOI_Last</xsl:text>
               </xsl:when>
               <xsl:otherwise>
                  <xsl:text>jrnlTblBlockDOI</xsl:text>
               </xsl:otherwise>								
            </xsl:choose>
        </xsl:if>
        <xsl:if test="$className = 'jrnleLifeDigestBlockDOI'">
            <xsl:choose>
               <xsl:when test ="count(./following-sibling::*)=0">
                    <xsl:text>jrnleLifeDigestBlockDOI_Last</xsl:text>
               </xsl:when>
               <xsl:otherwise>
                  <xsl:text>jrnleLifeDigestBlockDOI</xsl:text>
               </xsl:otherwise>								
            </xsl:choose>
        </xsl:if>
        <xsl:if test="$className = 'jrnlRefText'"><!--clasifying ref list-->
				...
				<xsl:variable name="listCount">
				   <xsl:choose>
				     <xsl:when test="count(//p[@class='jrnlRefText'][starts-with(., '*')]) &gt; 0">
				         <xsl:value-of select="concat(count(//p[@class='jrnlRefText']) , '0') " />
				     </xsl:when>
					  <xsl:when test="count(//p[@class='jrnlRefText'][starts-with(., 'w')]) &gt; 0">
				         <xsl:value-of select="concat(count(//p[@class='jrnlRefText']) , '0') " />
				     </xsl:when>
					  <xsl:otherwise>
				         <xsl:value-of select="count(//p[@class='jrnlRefText'])" />
				     </xsl:otherwise>
					 </xsl:choose>
				</xsl:variable>
      			<xsl:choose>
      				<xsl:when test="not(preceding-sibling::p[@class='jrnlRefText']) and (following-sibling::p[@class='jrnlRefText'])"><!--very first list if has more than one reference-->				  
                            <xsl:text>-T</xsl:text>
                            <!--Two digit lists-->			
                           ...
                           <!--Four digit lists-->			      				  
                              <xsl:if test="$listCount &gt; 999">
                                 <xsl:text>4</xsl:text>   
                              </xsl:if>
      				</xsl:when>
                      <xsl:when test="preceding-sibling::p[@class='jrnlRefText'] and not(following-sibling::p[@class='jrnlRefText'])"><!--very last list of reference if has more than one reference-->				  
                           <xsl:text>-B</xsl:text>
                           <!--Two digit lists-->			
                              <xsl:if test="$listCount &gt; 9 and ($listCount &lt; 100)">
                                 <xsl:text>2</xsl:text>   
                        ...
                        <xsl:when test="not(preceding-sibling::p[@class='jrnlRefText']) and not(following-sibling::p[@class='jrnlRefText'])"><!--if only one reference-->
                            <xsl:text>-O</xsl:text>					
                        </xsl:when>
                        <xsl:otherwise>
                       <xsl:choose>
                            <!--Two digit lists-->			      	           
                          <xsl:when test="$listCount &gt; 9 and not($listCount &gt; 99)">
                            ...
                            <!--Three digit lists-->			      				        	                  	                     				  
                        <xsl:when test="$listCount &gt; 99 and not($listCount &gt; 999)">
                            <xsl:choose>
                               <xsl:when test="count(preceding-sibling::p[@class='jrnlRefText']) &gt;= 99">
                                  <xsl:text>3-2</xsl:text>   
                               </xsl:when>
                               <xsl:when test="count(preceding-sibling::p[@class='jrnlRefText']) &gt;= 9 and not(count(preceding-sibling::p[@class='jrnlRefText']) &lt; 9)">
                                  <xsl:text>3-1</xsl:text>   
                               </xsl:when>                                                
                               <xsl:when test="count(preceding-sibling::p[@class='jrnlRefText']) &lt; 10 and $listCount &gt; 99">
                        ...
                        <xsl:otherwise>
                            <xsl:choose>
                               <xsl:when test="count(preceding-sibling::p[@class='jrnlRefText']) &gt;= 999">
        ...
        <xsl:if test="$className = 'jrnlAppRefText'"><!--clasifying ref list-->
                <xsl:text>jrnlAppRefText</xsl:text>
                <xsl:variable name="listCount" select="count(parent::div[@class='back']/child::p[@class='jrnlAppRefText'])" />
				<xsl:variable name="listCount">
				   <xsl:choose>
				     <xsl:when test="count(//p[@class='jrnlAppRefText'][starts-with(., '*')]) &gt; 0">
				         <xsl:value-of select="concat(count(//p[@class='jrnlAppRefText']) , '0') " />
				     </xsl:when>
					  <xsl:when test="count(//p[@class='jrnlAppRefText'][starts-with(., 'w')]) &gt; 0">
				         <xsl:value-of select="concat(count(//p[@class='jrnlAppRefText']) , '0') " />
				     </xsl:when>
					  <xsl:otherwise>
				         <xsl:value-of select="count(//p[@class='jrnlAppRefText'])" />
				     </xsl:otherwise>
					 </xsl:choose>
				</xsl:variable>
      			<xsl:choose>
      				<xsl:when test="not(preceding-sibling::p[@class='jrnlAppRefText']) and (following-sibling::p[@class='jrnlAppRefText'])"><!--very first list if has more than one reference-->				  
                        <xsl:text>-T</xsl:text>
                        <!--Two digit lists-->			
                          <xsl:if test="$listCount &gt; 9 and ($listCount &lt; 100)">
                             <xsl:text>2</xsl:text>   
                      ...
                      <xsl:when test="preceding-sibling::p[@class='jrnlAppRefText'] and not(following-sibling::p[@class='jrnlAppRefText'])"><!--very last list of reference if has more than one reference-->				  
                           <xsl:text>-B</xsl:text>
                           <!--Two digit lists-->			
                              <xsl:if test="$listCount &gt; 9 and ($listCount &lt; 100)">
                                 <xsl:text>2</xsl:text>   
                      ...
                      <xsl:when test="not(preceding-sibling::p[@class='jrnlAppRefText']) and not(following-sibling::p[@class='jrnlAppRefText'])"><!--if only one reference-->
                        <xsl:text>-O</xsl:text>					
                        </xsl:when>
                        <xsl:otherwise>
                       <xsl:choose>
                            <!--Two digit lists-->			      	           
                          <xsl:when test="$listCount &gt; 9 and not($listCount &gt; 99)">
                               <xsl:if test="count(preceding-sibling::p[@class='jrnlAppRefText']) &gt;= 9">
                                  <xsl:text>2-1</xsl:text>   
                               </xsl:if>
                               <xsl:if test="count(preceding-sibling::p[@class='jrnlAppRefText']) &lt; 9">
                                  <xsl:text>2-0</xsl:text>   
                        ...
                        <xsl:otherwise>
                            <xsl:choose>
                               <xsl:when test="count(preceding-sibling::p[@class='jrnlAppRefText']) &gt;= 99">
                                  <xsl:text>3-2</xsl:text>   
                               </xsl:when>
                               <xsl:when test="count(preceding-sibling::p[@class='jrnlAppRefText']) &gt;= 9 and not(count(preceding-sibling::p[@class='jrnlAppRefText']) &lt; 9)">
                                  <xsl:text>3-1</xsl:text>   
                               </xsl:when>                                                
                               <xsl:when test="count(preceding-sibling::p[@class='jrnlAppRefText']) &lt; 10 and $listCount &gt; 99">
                                  <xsl:text>3-0</xsl:text>   
                               </xsl:when>
                               <xsl:otherwise/>
                            </xsl:choose>
       ...
       <xsl:when test="$StyleName = 'jrnlTblBody' or $StyleName = 'jrnlTblHead'">
           <xsl:element name="{$nodeName}">
            ...
            <xsl:if test="./ancestor::td[@data-align]">
                    <xsl:choose>
                        <xsl:when test="./ancestor::td/@data-align = '&#x00B1;'">
                            <xsl:attribute name="data-align"><xsl:text>prm</xsl:text></xsl:attribute>
                        </xsl:when>
                        <xsl:otherwise>
           ...
           <xsl:if test="@data-font-size">
                <xsl:attribute name="reduceFont" select="./@data-font-size"/>
           </xsl:if>
             <xsl:apply-templates/>
            </xsl:element>        
       </xsl:when>
        <xsl:when test="not($StyleName = '')">
           <xsl:element name="{$nodeName}">
            <xsl:if test="@data-p-style">
                <xsl:attribute name="data-p-style" select="@data-p-style"/>
            </xsl:if>
              <xsl:attribute name="aid:pstyle" select="$StyleName"/>
              <xsl:attribute name="pstyle" select="$StyleName"/>
                <xsl:choose>
               ...
               <xsl:if test="starts-with($StyleName, 'jrnlRef') or starts-with($StyleName, 'jrnlAppRef') ">
                    <xsl:attribute name="data-word-spacing" select="@data-word-spacing"/>
    ...
    <xsl:choose>
        <xsl:when test="$className = 'jrnlPubIDLink'">
            <xsl:if test="following-sibling::*">
                <xsl:call-template name="Entermark" /> 
            </xsl:if>
        </xsl:when>
        <xsl:when test="$className = 'jrnlDataTitle'">
            <xsl:if test="following-sibling::*">
                <xsl:call-template name="Entermark" /> 
            </xsl:if>
        </xsl:when>
        <xsl:when test="$className = 'jrnlFunderTblHead'">
            <xsl:if test="following-sibling::*">
                <xsl:call-template name="Entermark" /> 
            </xsl:if>
        </xsl:when>
        <xsl:when test="$className = 'jrnlFunderTblBody'">
            <xsl:if test="following-sibling::*">
                <xsl:call-template name="Entermark" /> 
            </xsl:if>
        </xsl:when>
        <xsl:when test="$className = 'jrnDatasetTblHead'">
            <xsl:if test="following-sibling::*">
                <xsl:call-template name="Entermark" /> 
            </xsl:if>
        </xsl:when>
        <xsl:when test="$className = 'jrnlComment'">
            <xsl:if test="following-sibling::*">
                <xsl:call-template name="Entermark" /> 
            </xsl:if>
        </xsl:when>
        <xsl:when test="$className = 'jrnlDataAuthors'">
            <xsl:if test="following-sibling::*">
                <xsl:call-template name="Entermark" /> 
            </xsl:if>
        </xsl:when>
        <xsl:when test="$className = 'jrnlSource'">
            <xsl:if test="following-sibling::*">
                <xsl:call-template name="Entermark" /> 
            </xsl:if>
        </xsl:when>
        ...
        <xsl:when test="$className = 'jrnlRefNote' and count(./following-sibling::*)=0">
        </xsl:when>
        <xsl:when test="$className = 'jrnlRefNote' and ./following-sibling::*[1]/@class='jrnlAppBlock'">
        </xsl:when>
        <xsl:when test="$className = 'jrnlRefNote' and following-sibling::*[1]/@class='jrnlFootNoteFN'">
        </xsl:when>
        <xsl:when test="$className = 'jrnlRefText' and count(./following-sibling::*)=0">
            <xsl:if test="not(count(./parent::div[@class='jrnlRefBlock']/following-sibling::*)=0)">
                <xsl:call-template name="Entermark" /> 
            </xsl:if>
            <xsl:if test="not(count(./parent::div[@class='jrnlRefGroup']/following-sibling::*)=0)">
                <xsl:call-template name="Entermark" /> 
            </xsl:if>
        </xsl:when>
<!--        <xsl:when test="$className = 'jrnlRefText' and ./following-sibling::*[1]/@class='jrnlAppBlock'">
        ...
        <xsl:when test="$className = 'jrnlBlockDOI' and count(./following-sibling::*)=0 and count(parent::div/following-sibling::*) = 0">
        </xsl:when>
    ...
    <xsl:choose>   
        ...
        <xsl:otherwise>
            <xsl:variable name="subLevelPTag">
                   <xsl:choose>
                        <xsl:when test="@class='jrnlEqnPara'">
                            <xsl:choose>
                               <xsl:when test="not(preceding-sibling::*[1]/@class='jrnlEqnPara') and not(following-sibling::*[1]/@class='jrnlEqnPara') and not(following-sibling::*[1]/@class='jrnlEqnPara') and (following-sibling::*[1]/@class='jrnlHead1' or following-sibling::*[1]/@class='jrnlHead2' or following-sibling::*[1]/@class='jrnlHead3' or following-sibling::*[1]/@class='jrnlHead4' or  following-sibling::*[1]/@class='jrnlHead5' or  following-sibling::*[1]/@class='jrnlHead6' or  following-sibling::*[1]/@class='jrnlRefHead' or  following-sibling::*[1]/@class='jrnlAckHead')">
                                  <xsl:text>EQN-O-BEFORE-HEAD</xsl:text>
                               </xsl:when>   			
...
<xsl:template match = "//span[@class='jrnlFootNoteHead']" />
<xsl:template match = "//sup[@class='jrnlFootNoteHead']" />
<xsl:template match = "//span[@class='jrnlStyledContent']">
          <xsl:apply-templates/>        
</xsl:template>
<xsl:template match = "//span[@data-track='ins']">
          <xsl:apply-templates/>        
</xsl:template>
<xsl:template match = "//span[@data-spl-style]">
    <span>
...
<xsl:template match = "//span[@class='jrnlAbsHead']">
    <span>
          <xsl:attribute name="aid:cstyle">
                <xsl:value-of select="@class"/>
          </xsl:attribute>  
...
<xsl:template match = "//span[@class='jrnlPresentAddrFNHead']">
    <span>
          <xsl:attribute name="aid:cstyle">
                <xsl:value-of select="@class"/>
          </xsl:attribute>  
...
<xsl:template match = "//span[@class='jrnlEqualContribFNHead']">
    <span>
          <xsl:attribute name="aid:cstyle">
                <xsl:value-of select="@class"/>
          </xsl:attribute>  
...
<xsl:template match = "//span[@class='jrnlCompIntPointer']">
    <span>
          <xsl:attribute name="aid:cstyle">
                <xsl:value-of select="@class"/>
          </xsl:attribute>  
...
<xsl:template match = "//span[@class='jrnlHead1']">
    <span>
          <xsl:attribute name="aid:cstyle">
                <xsl:value-of select="@class"/>
          </xsl:attribute>  
...
<xsl:template match = "//span[@class='jrnlHead2']">
    <span>
          <xsl:attribute name="aid:cstyle">
                <xsl:value-of select="@class"/>
          </xsl:attribute>  
...
<xsl:template match = "//span[@class='jrnlHead3']">
    <span>
          <xsl:attribute name="aid:cstyle">
                <xsl:value-of select="@class"/>
          </xsl:attribute>  
...
<xsl:template match = "//span[@class='jrnlHead4']">
    <span>
          <xsl:attribute name="aid:cstyle">
                <xsl:value-of select="@class"/>
          </xsl:attribute>  
...
<xsl:template match = "//span[@class='jrnlHead5']">
    <span>
          <xsl:attribute name="aid:cstyle">
                <xsl:value-of select="@class"/>
          </xsl:attribute>  
...
<xsl:template match = "//span[@class='jrnlSpeaker']">
    <span>
          <xsl:attribute name="aid:cstyle">
                <xsl:value-of select="@class"/>
          </xsl:attribute>  
...
<xsl:template match = "//span[@class='jrnlTblFootLabel']">
    <span>
        <xsl:choose>
            <xsl:when test="contains(., '*')">
              <xsl:attribute name="aid:cstyle">
                    <xsl:text>NO_SUP_ASTK_</xsl:text><xsl:value-of select="@class"/>
              </xsl:attribute>  
              <xsl:attribute name="cstyle">
                    <xsl:value-of select="@class"/>
              </xsl:attribute>              
...
<xsl:template match = "//span[@class='jrnlSupplRef']">
    <span>
          <xsl:attribute name="aid:cstyle">
                <xsl:value-of select="@class"/>
          </xsl:attribute>  
...
<xsl:template match = "//span[@class='jrnlRemoveBold']">
    <span>
          <xsl:attribute name="aid:cstyle">
                <xsl:value-of select="@class"/>
          </xsl:attribute>  
...
<xsl:template match = "//span[@class='jrnlFontTimes-New-Roman_Regular']">
   <span>
         <xsl:attribute name="aid:cstyle">
               <xsl:value-of select="@class"/>
         </xsl:attribute>  
...
<xsl:template match = "//span[@class='jrnlFontTimes-New-Roman_Italic']">
   <span>
         <xsl:attribute name="aid:cstyle">
               <xsl:value-of select="@class"/>
         </xsl:attribute>  
...
<xsl:template match = "//span[@class='jrnlFontTimes-New-Roman_Bold']">
   <span>
         <xsl:attribute name="aid:cstyle">
               <xsl:value-of select="@class"/>
         </xsl:attribute>  
...
<xsl:template match = "//u">
    <xsl:choose>
        <xsl:when test="ancestor::p[@class='jrnlListPara']/ancestor::ol/ancestor::div[@class='jrnlBoxBlock'] and parent::strong">
            <jrnlBoxOLListBoldUline>
            <xsl:attribute name="aid:cstyle">
            <xsl:text>jrnlBoxOLListBoldUline</xsl:text>
            </xsl:attribute>  
            <xsl:apply-templates/>        
            </jrnlBoxOLListBoldUline>     
        </xsl:when>
...
<xsl:template match = "//b|//strong">
    <xsl:choose>
        ...
        <xsl:when test="parent::p[@class='jrnlTblFoot']">
            <span>
                  <xsl:attribute name="aid:cstyle">
                      <xsl:text>jrnlTblFootBold</xsl:text>
                  </xsl:attribute>  
                  <xsl:apply-templates/>        
             </span>     
        </xsl:when>
        ...
        <xsl:when test="ancestor::p[@class='jrnlBoxText'] and (./parent::u or ./child::u)">
            <jrnlBoxTextBoldUline>
                  <xsl:attribute name="aid:cstyle">
                      <xsl:text>jrnlBoxTextBoldUline</xsl:text>
                  </xsl:attribute>  
                  <xsl:apply-templates/>        
             </jrnlBoxTextBoldUline>     
        </xsl:when>
        ...
        <xsl:when test="ancestor::p[@class='jrnlTblBody'] and not(ancestor::thead) and (./parent::u or ./child::u)">
            <jrnlTblBodyBoldUline>
                  <xsl:attribute name="aid:cstyle">
                      <xsl:text>jrnlTblBodyBoldUline</xsl:text>
                  </xsl:attribute>  
                  <xsl:apply-templates/>        
             </jrnlTblBodyBoldUline>     
        </xsl:when>
        <xsl:when test="ancestor::p[@class='jrnlTblBody'] and not(ancestor::thead)">
            <jrnlTblBodyBold>
                  <xsl:attribute name="aid:cstyle">
        ...
        <xsl:when test="ancestor::p[@class='jrnlTblHead'] or ancestor::p[@class='jrnlTblBody']/ancestor::thead">
            <jrnlTblHeadBold>
                  <xsl:attribute name="aid:cstyle">
...
<xsl:template match = "//sup">
    <xsl:choose>
        <xsl:when test="parent::p[@class='jrnlTblHead']">
            <span aid:cstyle="jrnlTblHeadSup">
                  <xsl:attribute name="cstyle">
                      <xsl:text>jrnlTblHeadSup</xsl:text>
                  </xsl:attribute>  
                  <xsl:apply-templates/>
            </span>  
        </xsl:when>
        <xsl:when test="parent::p[@class='jrnlTblBody'] and ancestor::thead">
            <span aid:cstyle="jrnlTblHeadSup">
                  <xsl:attribute name="cstyle">
                      <xsl:text>jrnlTblHeadSup</xsl:text>
                  </xsl:attribute>  
        ...
        <xsl:when test="ancestor::p[@class='jrnlTblCaption'] and ./child::em">
            <span aid:cstyle="jrnlTblBodyItalicSup">
                  <xsl:attribute name="cstyle">
                      <xsl:text>jrnlTblCaptionSupItalic</xsl:text>
                  </xsl:attribute>  
                  <xsl:apply-templates/>
            </span>  
        </xsl:when>
        <xsl:when test="ancestor::p[@class='jrnlTblBody'] and ./child::em">
            <span aid:cstyle="jrnlTblBodyItalicSup">
                  <xsl:attribute name="cstyle">
        ...
        <xsl:when test="ancestor::p[@class='jrnlTblFoot'] and ./child::em">
        ...
        <xsl:when test="@class='jrnlFootNoteHead'"/>
        <xsl:otherwise>
            <sup>
                  <xsl:apply-templates/>                
            </sup>
...
<xsl:template match = "//p[@class='jrnlTblBody']//em//sup">
    <span aid:cstyle="jrnlTblBodyItalicSup">
          <xsl:attribute name="cstyle">
              <xsl:text>jrnlTblBodyItalicSup</xsl:text>
          </xsl:attribute>  
...
<xsl:template match = "//thead//p[@class='jrnlTblBody']/sub">
    <span aid:cstyle="jrnlTblHeadSub">
          <xsl:attribute name="cstyle">
              <xsl:text>jrnlTblHeadSub</xsl:text>
          </xsl:attribute>  
          <xsl:apply-templates/>
    </span>  
</xsl:template>
<xsl:template match = "//p[@class='jrnlTblHead']/sub">
    <span aid:cstyle="jrnlTblHeadSub">
          <xsl:attribute name="cstyle">
              <xsl:text>jrnlTblHeadSub</xsl:text>
          </xsl:attribute>  
...
<xsl:template match = "//p[@class='jrnlTblCaption']/sub">
    <span aid:cstyle="jrnlTblCaptionSub">
          <xsl:attribute name="cstyle">
              <xsl:text>jrnlTblCaptionSub</xsl:text>
          </xsl:attribute>  
          <xsl:apply-templates/>
    </span>  
</xsl:template>
<xsl:template match = "//p[@class='jrnlFigCaption']/sub">
    <span aid:cstyle="jrnlFigCaptionSub">
          <xsl:attribute name="cstyle">
              <xsl:text>jrnlFigCaptionSub</xsl:text>
          </xsl:attribute>  
          <xsl:apply-templates/>
    </span>  
</xsl:template>
<xsl:template match = "//p[@class='jrnlBoxCaption']/sub">
    <span aid:cstyle="jrnlBoxCaptionSub">
          <xsl:attribute name="cstyle">
              <xsl:text>jrnlBoxCaptionSub</xsl:text>
          </xsl:attribute>  
          <xsl:apply-templates/>
    </span>  
</xsl:template>
<xsl:template match = "//p[@class='jrnlTblBody']/sub">
    <span aid:cstyle="jrnlTblBodySub">
          <xsl:attribute name="cstyle">
              <xsl:text>jrnlTblBodySub</xsl:text>
          </xsl:attribute>  
          <xsl:apply-templates/>
    </span>  
</xsl:template>
<xsl:template match = "//tr[@data-p-thead='true']//p[@class='jrnlTblBody']/sub">
    <span aid:cstyle="jrnlTblHeadSub">
          <xsl:attribute name="cstyle">
              <xsl:text>jrnlTblHeadSub</xsl:text>
          </xsl:attribute>  
...
<xsl:template match = "//em">
    <xsl:choose>
        <xsl:when test="./parent::p[@class='jrnlBlockQuote']">
            <xsl:choose>
                <xsl:when test="./ancestor::div[@class='jrnlBoxBlock']">
                    <span>
                          <xsl:attribute name="aid:cstyle">
                              <xsl:text>jrnlBoxBlockQuoteItalic</xsl:text>
                          </xsl:attribute>  
                          <xsl:apply-templates/>        
                     </span>     
                </xsl:when>
                <xsl:otherwise>
                    <span>
                          <xsl:attribute name="aid:cstyle">
                              <xsl:text>jrnlBlockQuoteItalic</xsl:text>
                          </xsl:attribute>  
                          <xsl:apply-templates/>        
                     </span>                         
                </xsl:otherwise>
        ...
        <xsl:when test="./ancestor::p[@class='jrnlSTLH']">
            <span>
                  <xsl:attribute name="aid:cstyle">
                      <xsl:text>jrnlSTLHItalic</xsl:text>
                  </xsl:attribute>  
                  <xsl:apply-templates/>        
             </span>     
        </xsl:when>
        <xsl:when test="./ancestor::p[@class='jrnlSTRH']">
            <span>
                  <xsl:attribute name="aid:cstyle">
                      <xsl:text>jrnlSTRHItalic</xsl:text>
                  </xsl:attribute>  
                  <xsl:apply-templates/>        
             </span>     
        </xsl:when>
        <xsl:when test="./ancestor::p[@class='jrnlPresentedFN']">
            <span>
                  <xsl:attribute name="aid:cstyle">
                      <xsl:text>jrnlPresentedFNItalic</xsl:text>
                  </xsl:attribute>  
                  <xsl:apply-templates/>        
             </span>     
        </xsl:when>
        <xsl:when test="./parent::span[@class='jrnlOnBehalfOf']">
            <span>
                  <xsl:attribute name="aid:cstyle">
                      <xsl:text>jrnlOnBehalfOfItalic</xsl:text>
                  </xsl:attribute>  
                  <xsl:apply-templates/>        
             </span>     
        </xsl:when>
        <xsl:when test="./ancestor::p[@class='jrnlFundGroup']">
            <span>
                  <xsl:attribute name="aid:cstyle">
                      <xsl:text>jrnlFundGroupItalic</xsl:text>
                  </xsl:attribute>  
                  <xsl:apply-templates/>        
             </span>     
        </xsl:when>
        <xsl:when test="./ancestor::p[@class='jrnlDataSharingFN']">
            <span>
                  <xsl:attribute name="aid:cstyle">
                      <xsl:text>jrnlDataSharingFNItalic</xsl:text>
                  </xsl:attribute>  
                  <xsl:apply-templates/>        
             </span>     
        </xsl:when>
        <xsl:when test="./ancestor::p[@class='jrnlConFN']">
            <span>
                  <xsl:attribute name="aid:cstyle">
                      <xsl:text>jrnlConFNItalic</xsl:text>
                  </xsl:attribute>  
                  <xsl:apply-templates/>        
             </span>     
        </xsl:when>
        ...
        <xsl:when test="./parent::span[@class='jrnlArtTitle']/parent::p[@class='txtCiteInfo']">
            <span>
                  <xsl:attribute name="aid:cstyle">
                      <xsl:text>txtCiteInfoJrnlArtTitleItalic</xsl:text>
                  </xsl:attribute>  
                  <xsl:apply-templates/>        
             </span>     
        </xsl:when>
		...
		<xsl:when test="ancestor::p[@class='jrnlBoxFootFirst']">
            <jrnlBoxFootFirstItalic>
                  <xsl:attribute name="aid:cstyle">
                      <xsl:text>jrnlBoxFootFirstItalic</xsl:text>
                  </xsl:attribute>  
                  <xsl:apply-templates/>        
             </jrnlBoxFootFirstItalic>     
        </xsl:when>
        ...
        <xsl:when test="parent::p[@class='jrnlArtTitle']">
            <jrnlArtTitleItalic>
                  <xsl:attribute name="aid:cstyle">
                    <xsl:if test="./ancestor::div[@class='front']/@prefix">
                            <xsl:value-of select="./ancestor::div[@class='front']/@prefix"/><xsl:text>_</xsl:text>
                    </xsl:if>
        ...
        <xsl:when test="ancestor::ul or ancestor::ol">
            <span>
                <xsl:choose>
                    ...
                    <xsl:when test="(ancestor::table and child::strong) or (ancestor::table and parent::strong)">
                          <xsl:attribute name="aid:cstyle">
                              <xsl:text>jrnlTblListBoldItalic</xsl:text>
                          </xsl:attribute>                      
                    </xsl:when>
                    <xsl:when test="ancestor::table">
                          <xsl:attribute name="aid:cstyle">
                              <xsl:text>jrnlTblListItalic</xsl:text>
                          </xsl:attribute>                      
                    </xsl:when>
                    <xsl:otherwise>
                          <xsl:attribute name="aid:cstyle">
        ...
        <xsl:when test="ancestor::span[@class='RefSource']">
            <jrnlAbsParaItalic>
                  <xsl:attribute name="aid:cstyle">
                      <xsl:text>RefSourceItalic</xsl:text>
                  </xsl:attribute>  
                  <xsl:apply-templates/>        
             </jrnlAbsParaItalic>     
        </xsl:when>
        <xsl:when test="ancestor::span[@class='RefCollaboration']">
            <jrnlAbsParaItalic>
                  <xsl:attribute name="aid:cstyle">
                      <xsl:text>RefCollaborationItalic</xsl:text>
                  </xsl:attribute>  
                  <xsl:apply-templates/>        
             </jrnlAbsParaItalic>     
        </xsl:when>
        ...
        <xsl:when test="ancestor::p[@class='jrnlTblCaption'] and parent::sup">
        ...
        <xsl:when test="ancestor::thead and not(parent::sup) and parent::strong">
            <jrnlTblHeadItalic>
                  <xsl:attribute name="aid:cstyle">
                      <xsl:text>jrnlTblHeadBoldItalic</xsl:text><!--jrnlTblBodyBoldItalic-->
                  </xsl:attribute>  
                  <xsl:apply-templates/>        
             </jrnlTblHeadItalic>     
        </xsl:when>
        <xsl:when test="ancestor::thead">
            <jrnlTblHeadItalic>
                  <xsl:attribute name="aid:cstyle">
                      <xsl:text>jrnlTblHeadItalic</xsl:text><!--jrnlTblBodyBoldItalic-->
                  </xsl:attribute>  
                  <xsl:apply-templates/>        
             </jrnlTblHeadItalic>     
        </xsl:when>
        <xsl:when test="ancestor::p[@class='jrnlTblBody'] and not(parent::sup) and parent::strong">
            <jrnlTblBodyItalic>
                  <xsl:attribute name="aid:cstyle">
        ...
        <xsl:when test="ancestor::p[@class='jrnlTblBody'] and not(parent::sup)">
            <jrnlTblBodyItalic>
                  <xsl:attribute name="aid:cstyle">
...
<!--italic inside head levels-->
        ...
        <xsl:when test = "ancestor::p[@class='jrnlTblBody'] and ./parent::sup">
            <jrnlTblBodyItalicSup>
                  <xsl:attribute name="aid:cstyle">
                      <xsl:text>jrnlTblBodyItalicSup</xsl:text>
                  </xsl:attribute>  
                  <xsl:apply-templates/>        
...
<xsl:template match="//span[@class='jrnlBibRef']">
        ...
        <xsl:choose>
            <xsl:when test="ancestor::div[@class='jrnlAppRefBlock']">
                <xsl:attribute name="aid:cstyle">
                    <xsl:if test="@data-p-nobreak='false'">
                            <xsl:text>NO_BREAK_</xsl:text>
                    </xsl:if>
                    <xsl:if test="@data-no-sup">
                            <xsl:text>NO_SUP_</xsl:text>
                    </xsl:if>
                    <xsl:text>jrnlAppBibRef</xsl:text>
                </xsl:attribute>
            </xsl:when>
            <xsl:when test="ancestor::p[@class='jrnlBoxCaption']">
                <xsl:attribute name="aid:cstyle">
            ...
            <xsl:when test="ancestor::p[@class='jrnlBoxTitle']">
                <xsl:attribute name="aid:cstyle">
                    <xsl:if test="@data-p-nobreak='false'">
                            <xsl:text>NO_BREAK_</xsl:text>
                    </xsl:if>
                    ...
                    <xsl:text>jrnlBibRefJrnlBoxTitle</xsl:text>
                </xsl:attribute>
            </xsl:when>
            <xsl:when test="ancestor::p[@class='jrnlTblCaption']">
                <xsl:attribute name="aid:cstyle">
            ...
            <xsl:when test="ancestor::h4[@class='jrnlHead4']">
                <xsl:attribute name="aid:cstyle">
                    ...
                    <xsl:text>jrnlBibRefHead4</xsl:text>
                </xsl:attribute>
            </xsl:when>
            <xsl:otherwise>
                <xsl:attribute name="aid:cstyle">
...
<xsl:template match="//span[@class='jrnlVidRef']">
    <xsl:variable name="parentParaClassName">
      <xsl:value-of select="parent::*/@class"/>   
   </xsl:variable>
    <xsl:choose>
        <xsl:when test="starts-with($parentParaClassName, 'jrnlHead')">
            <span>
                <xsl:attribute name="aid:cstyle" select="concat($parentParaClassName,@class)"/>
                <xsl:apply-templates  select="@* | node()"/>
            </span>            
        </xsl:when>
        <xsl:when test="contains($parentParaClassName, 'Caption')">
            <span>
                <xsl:attribute name="aid:cstyle" select="concat($parentParaClassName,@class)"/>
                <xsl:apply-templates  select="@* | node()"/>
            </span>            
...
<xsl:template match="//span[@class='jrnlTblFNRef']">
    <span>
        <xsl:attribute name="aid:cstyle" select="@class"/>
        <xsl:apply-templates  select="@* | node()"/>
    </span>
...
<!--force align-->
<xsl:template match = "//span[@class='forceJustify']|//span[@data-content-type='forceJustify']">
    <forceJustify>
              <xsl:text>&#x2028;</xsl:text>
     </forceJustify>     
</xsl:template>
...
<xsl:template match="//img">
    <xsl:choose>
        ...
        <xsl:when test="./ancestor::div[@class='jrnlFigBlock'] and not(ancestor::p[@class='jrnlFigCaption'])">
            <fig>
                <xsl:attribute name="aid:pstyle">
                    <xsl:text>FIG</xsl:text>
                </xsl:attribute>	     
        ...
        <xsl:when test="parent::p[@class='jrnlEqnPara']">
            ...
            <matchEqn>
                ...
                <rightIndent>
                      <xsl:attribute name="aid:cstyle"><xsl:text>rightIndent</xsl:text></xsl:attribute>
                      <xsl:attribute name="cstyle"><xsl:text>rightIndent</xsl:text></xsl:attribute>
                    <xsl:text>&#0009;</xsl:text>
                </rightIndent>
        </xsl:when>
        <xsl:when test="(ancestor::*[@class='jrnlPara'] or ancestor::*[@class='txtCiteInfo'] or ancestor::*[@class='jrnlHead1'] or ancestor::*[@class='jrnlHead2'] or ancestor::*[@class='jrnlHead3'] or ancestor::*[@class='jrnlHead4'] or ancestor::*[@class='jrnlHead5'] or parent::p[@class='jrnlSecPara'] or ancestor::p[@class='jrnlAbsPara'] or ancestor::p[@class='jrnlArtTitle'] or ancestor::p[@class='jrnlTblFoot'] or ancestor::p[@class='jrnlTblBody'] or parent::p[@class='jrnlListPara'] or ancestor::p[@class='jrnlTblCaption'] or ancestor::p[@class='jrnlFigCaption'] or ancestor::p[@class='jrnlBoxCaption']) and (@class='kriyaFormula')">
            <matchEqn>
                <xsl:choose>
                    <xsl:when test="not(@data-eq-depth = 0)">
                        <xsl:attribute name="cstyle"  select="concat('jrnlMathBaselineShift_',@data-eq-depth)" />
		...
		<xsl:when test="parent::p[@class='jrnlSecPara']">
            <matchEqn>
                <xsl:attribute name="cstyle"><xsl:value-of select="'FIG_INLINE_TEXT'"/></xsl:attribute>
				<xsl:attribute name="aid:cstyle"><xsl:value-of select="'FIG_INLINE_TEXT'"/></xsl:attribute> 
                <box-inline-fig>
                    <xsl:attribute name="cstyle"  select="@class" />
                    <xsl:attribute name="href">
                    <xsl:variable name="figurePath" select="replace(@src, '(\{\.\})(.*)$', '$2')"/>
		...
		<xsl:when test="parent::p[@class='jrnlBoxText']">
            <matchEqn>
                <xsl:attribute name="cstyle"><xsl:value-of select="'FIG_INLINE_BOX'"/></xsl:attribute>
				<xsl:attribute name="aid:cstyle"><xsl:value-of select="'FIG_INLINE_BOX'"/></xsl:attribute> 
                <box-inline-fig>
                    <xsl:attribute name="cstyle"  select="@class" />
                    <xsl:attribute name="href">
                    <xsl:variable name="figurePath" select="replace(@src, '(\{\.\})(.*)$', '$2')"/>
        ...
        <xsl:when test="ancestor::p[@class='jrnlFigCaption'] or ancestor::p[@class='jrnlTblCaption'] or ancestor::p[@class='jrnlBoxCaption']">
            <figure>
                <xsl:attribute name="aid:cstyle">
        ...
        <xsl:otherwise>
            ...
            <xsl:choose>
                ...
                <xsl:when test="(ancestor::td or ancestor::th) and ancestor::p[@class='jrnlTblFoot']">
                </xsl:when>
                <xsl:otherwise>
                    <xsl:call-template name="Entermark" /> 	
                </xsl:otherwise>
        ...
        <xsl:otherwise>
           <pFig>
            ...
            <Table xmlns:aid="http://ns.adobe.com/AdobeInDesign/4.0/" aid:table="table" aid:trows="{$rowsCt}" aid:tcols="{$colsCt}" aid5:tablestyle="{$styleValue}" class="{$styleValue}"><!--aid5:tablestyle="{$styleValue}" class="{$styleValue}">-->
                    <xsl:if test="./@data-padding-left">
                        <xsl:attribute name="data-padding-left">
                            <xsl:value-of select="./@data-padding-left"/>
                        </xsl:attribute>	     
                    </xsl:if>
                    <xsl:if test="./@data-padding-right">
                        <xsl:attribute name="data-padding-right">
                            <xsl:value-of select="./@data-padding-right"/>
                        </xsl:attribute>	     
                    </xsl:if>
                    <xsl:if test="./@data-p-span='true'">
                        <xsl:attribute name="data-p-span">
                            <xsl:value-of select="./@data-p-span"/>
                        </xsl:attribute>	     
                    </xsl:if>
                    ...
                    <xsl:choose>
                        <xsl:when test="parent::div[@class='jrnlTblBlock']">
                            <xsl:call-template name="Entermark" /> 
                        </xsl:when>
                        <xsl:when test="following-sibling::*[1]/@class='jrnlSecPara'">
                            <xsl:call-template name="Entermark" /> 
                        </xsl:when>
                        <xsl:when test="(parent::div[@class='jrnlFundingGroup'] or parent::div[@class='jrnlMajorDatasets'])">
                            <xsl:call-template name="Entermark" /> 
                        </xsl:when>
                        <xsl:when test="not(parent::div[@class='jrnlTblBlock']) and not(count(./following-sibling::*)=0)">
                            <xsl:call-template name="Entermark" /> 
                        </xsl:when>
                        <xsl:otherwise>
                        </xsl:otherwise>
...
<xsl:template match="td">
	<Cell aid:table="cell">
        <xsl:if test="./parent::tr[@data-height]">
            <xsl:attribute name="data-height" select="./parent::tr[@data-height]/@data-height"/>
        </xsl:if>
        <xsl:if test="@data-height">
            <xsl:attribute name="data-height" select="./@data-height"/>
        </xsl:if>
        <xsl:if test="@data-border-top='true'">
            <xsl:attribute name="data-border-top" select="./@data-border-top"/>
        </xsl:if>
        <xsl:if test="@data-border-bottom='true'">
            <xsl:attribute name="data-border-bottom" select="./@data-border-bottom"/>
        </xsl:if>
        <xsl:if test="@data-border-left='true'">
            <xsl:attribute name="data-border-left" select="./@data-border-left"/>
        </xsl:if>
        <xsl:if test="@data-border-right='true'">
            <xsl:attribute name="data-border-right" select="./@data-border-right"/>
        </xsl:if>
...
<!--	  <xsl:attribute name="aid:ccolwidth">since we have changed to logic to pull cell width through table setter this attribute has been commented on 28-Jun-2016
	  ...
	  <xsl:attribute name="align">	  
        ...
        <xsl:variable name="rotateStyle">        
            <xsl:choose>
                <xsl:when test="./@data-rotate='vertical'">
                    <xsl:text>_ROT_VER</xsl:text>
                </xsl:when>
                <xsl:when test="./@data-rotate='diagonal'">
                    <xsl:text>_ROT_DIA</xsl:text>
                </xsl:when>
               <xsl:otherwise/>
            </xsl:choose>
        </xsl:variable>
      ...
      <xsl:choose>
      <xsl:when test="ancestor::thead">
            <xsl:attribute name="aid5:cellstyle" select="concat('TCH',$rotateStyle,$valignStyle,$cellFill)">
            </xsl:attribute>
        </xsl:when>
      <xsl:when test="parent::tr[@data-p-thead='true']">
        ...
        <xsl:when test="count(parent::tr/preceding-sibling::tr) = 0 and (@data-cell-border='no-border')">
            <xsl:attribute name="aid5:cellstyle" select="concat('TBF_NB',$rotateStyle,$valignStyle,$cellFill)"/>
        ...
        <xsl:when test="count(parent::tr/preceding-sibling::tr) = 0 and (@data-cell-border='dotted-border')">
            <xsl:attribute name="aid5:cellstyle" select="concat('TBF_DB',$rotateStyle,$valignStyle,$cellFill)"/>
        ...
        <xsl:when test="count(parent::tr/preceding-sibling::tr) = 0 and ancestor::tbody/parent::table[@class='jrnlKeyPoints']">
            <xsl:attribute name="aid5:cellstyle" select="concat('keyPointsBody_first',$rotateStyle,$valignStyle,$cellFill)"/>
        </xsl:when>
        <xsl:when test="count(parent::tr/preceding-sibling::tr) = 0 and @rowspan">
            ...
            <xsl:choose>
                ...
                <xsl:when test="($rowSpanCount) = $followingTRCount and parent::tr/following-sibling::tr[$rowSpanCount]//p[@class='jrnlTblFoot']">
                    <xsl:choose>
                        <xsl:when test="ancestor::div[@class='jrnlTblBlock']/parent::div[@class='jrnlTblBlockGroup'] and ancestor::div[@class='jrnlTblBlock']/following-sibling::*[1]/@class='jrnlTblBlock' and not(ancestor::table/following-sibling::*[1]/@class='jrnlTblCaption')">
                            <xsl:attribute name="aid5:cellstyle" select="concat('TBFL_STACK',$rotateStyle,$valignStyle,$cellFill)"/>                            
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:attribute name="aid5:cellstyle" select="concat('TBFL',$rotateStyle,$valignStyle,$cellFill)"/>
                        </xsl:otherwise>
                    </xsl:choose>
                </xsl:when>
                ...
                <xsl:otherwise>                
                    <xsl:attribute name="aid5:cellstyle" select="concat('TBF',$rotateStyle,$valignStyle,$cellFill)"/>
                </xsl:otherwise>                
            </xsl:choose>                    
        </xsl:when>
        ...
        <xsl:when test="count(parent::tr/following-sibling::tr) = 0 and ancestor::tbody/parent::table[@class='jrnlKeyPoints']">
            <xsl:attribute name="aid5:cellstyle" select="concat('keyPointsBody_last',$rotateStyle,$valignStyle,$cellFill)"/>
        </xsl:when>
        <xsl:when test="./p[@class='jrnlTblFoot']">
            <xsl:choose>
                <xsl:when test="ancestor::div[@class='jrnlTblBlock']/parent::div[@class='jrnlTblBlockGroup'] and ancestor::div[@class='jrnlTblBlock']/following-sibling::*[1]/@class='jrnlTblBlock' and not(ancestor::table/following-sibling::*[1]/@class='jrnlTblCaption')">
                    <xsl:attribute name="aid5:cellstyle" select="concat('TBFN_STACK',$rotateStyle,$valignStyle,$cellFill)"/>                            
                </xsl:when>
                <xsl:otherwise>
                    <xsl:attribute name="aid5:cellstyle" select="concat('TBFN',$rotateStyle,$valignStyle,$cellFill)"/>
                </xsl:otherwise>
            </xsl:choose>
        </xsl:when>
        <xsl:when test="@rowspan">
            ...
            <xsl:choose>
                ...
                <xsl:when test="($rowSpanCount) = $followingTRCount and parent::tr/following-sibling::tr[$rowSpanCount]//p[@class='jrnlTblFoot']">
                    <xsl:choose>
                        <xsl:when test="ancestor::div[@class='jrnlTblBlock']/parent::div[@class='jrnlTblBlockGroup'] and ancestor::div[@class='jrnlTblBlock']/following-sibling::*[1]/@class='jrnlTblBlock' and not(ancestor::table/following-sibling::*[1]/@class='jrnlTblCaption')">
                            <xsl:attribute name="aid5:cellstyle" select="concat('TBL_STACK',$rotateStyle,$valignStyle,$cellFill)"/>                            
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:attribute name="aid5:cellstyle" select="concat('TBL',$rotateStyle,$valignStyle,$cellFill)"/>
                        </xsl:otherwise>
                    </xsl:choose>
                </xsl:when>
                <!--td with row span and not followed by footnote-->
                ...
                <xsl:otherwise>                
                    <xsl:attribute name="aid5:cellstyle"  select="concat('TB',$rotateStyle,$valignStyle,$cellFill)"/>
                </xsl:otherwise>                
            </xsl:choose>                    
        </xsl:when>
        ...
        <xsl:when test="@data-cell-border='no-border'">
            <xsl:attribute name="aid5:cellstyle" select="concat('TB_NB',$rotateStyle,$valignStyle,$cellFill)"/>
            <xsl:attribute name="borderStyle"><xsl:text>TB_NB</xsl:text></xsl:attribute>
        </xsl:when>
        <xsl:when test="@data-cell-border='dotted-border'">
            <xsl:attribute name="aid5:cellstyle" select="concat('TB_DB',$rotateStyle,$valignStyle,$cellFill)"/>
	  ...
	  <xsl:attribute name="align">	  
 	  ...
 	  <xsl:choose>
            <xsl:when test="//ancestor::thead/parent::table[@class='jrnlKeyPoints']">
                <xsl:attribute name="aid5:cellstyle" select="concat('keyPointsHead',$rotateStyle,$valignStyle,$cellFill)"/>
            </xsl:when>
            <xsl:otherwise>
                <xsl:attribute name="aid5:cellstyle" select="concat('TCH',$rotateStyle,$valignStyle,$cellFill)"/>
            </xsl:otherwise>
...
<xsl:template match="//li">
      <xsl:variable name="precedingNodeClassName" select="parent::ol/preceding-sibling::*[1]/@style | parent::ol/preceding-sibling::*[1]/@class"/>            
   	<xsl:if test="parent::ol">
   	  <nl>
           <xsl:if test="parent::*[@data-font-size]">
                <xsl:attribute name="reduceFont" select="./parent::*[@data-font-size]/@data-font-size"/>
           </xsl:if>
		   <xsl:if test="parent::*[@start]">
                <xsl:attribute name="start-alpha" select="./parent::*[@start]/@start"/>
           </xsl:if>
           <xsl:if test="./child::p[@data-font-size]">
                <xsl:attribute name="reduceFont" select="./child::p[@data-font-size]/@data-font-size"/>
           </xsl:if>
            ...
            <xsl:choose>
               <xsl:when test="child::p[@data-spl-style]"><!--If the requirement is any specific style for paragraphs, then we could use that style name in this attribute and should be matched on template-->
               </xsl:when>
            ...
            <xsl:variable name="previousText">
               ...
               <xsl:variable name="listCount" select="count(parent::ol/child::li) + $startsWithValue" />
      			...
      			<xsl:choose>
                       <xsl:when test="child::p[@data-spl-style]"><!--If the requirement is any specific style for paragraphs, then we could use that style name in this attribute and should be matched on template-->
                          <xsl:value-of select="./child::p[@data-spl-style]/@data-spl-style"/>
                       </xsl:when>
      	           ...
      	           <!--Three digit lists-->			      				  
                        ...
                        <xsl:when test="preceding-sibling::li and not(following-sibling::li) and not(child::ul or child::ol)">
      				  <xsl:value-of select="$precedingBlockType"/>
      				  <xsl:value-of select="$subLevel"/>
      				  <xsl:value-of select="$styleType"/>      			                  
                        <xsl:text>-B</xsl:text>
   	...
   	<xsl:if test="parent::ul">
   	  <xsl:choose>
         			...
         			<xsl:choose>
                        ...
                        <xsl:when test="preceding-sibling::li and not(following-sibling::li) and not(child::ul or child::ol)">
         				  ...
         				  <xsl:value-of select="$subLevel"/>
                            ...
                            <xsl:if test="ancestor::div[@class='jrnlAbsGroup'] and count(parent::ul/following-sibling::*)=0">
                                    <xsl:text>-ABS_LAST</xsl:text>
                            </xsl:if>
                        </xsl:when>
           ...
           <xsl:when test="parent::ul/@type='square'"><!--square list-->
   	     ...
   	     <xsl:when test="parent::ul/@type='right-triangle' or parent::ul/@class='right-triangle' or parent::ul/@list-style-type='right-triangle'  or parent::ul/@type='right-triangle'" ><!--Open arrow list-->
         	  <OAL>
                   <xsl:if test="parent::*[@data-font-size]">
                        <xsl:attribute name="reduceFont" select="./parent::*[@data-font-size]/@data-font-size"/>
                   </xsl:if>
               ...
               <xsl:attribute name="aid:pstyle">
         			<xsl:choose>
         				<xsl:when test="not(preceding-sibling::li) and (following-sibling::li or child::ol or child::ul) and not(parent::*[1]/preceding-sibling::*[1][name()='jrnlHead1'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead2'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead3'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead4'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead5'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead6'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlRefHead'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlAckHead'])">
         				  <xsl:value-of select="$ancestorTbl"/>
         				  <xsl:value-of select="$subLevel"/>
         	            <xsl:text>OAL-T</xsl:text>		
         				</xsl:when>
                        <xsl:when test="preceding-sibling::li and not(following-sibling::li) and not(child::ul or child::ol)">
         				  <xsl:value-of select="$ancestorTbl"/>
         				  <xsl:value-of select="$subLevel"/>
                            <xsl:text>OAL-B</xsl:text>					
                            <xsl:if test="parent::*[1]/following-sibling::*[1][name()='jrnlHead1'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead2'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead3'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead4'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead5'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead6'] or parent::*[1]/following-sibling::*[1][name()='jrnlRefHead'] or parent::*[1]/following-sibling::*[1][name()='jrnlAckHead']">
                                <xsl:text>-BEFORE-HEAD</xsl:text>   
                            </xsl:if>                      
                            <xsl:if test="ancestor::div[@class='jrnlAbsGroup'] and count(./parent::ol/following-sibling::*)=0">
           ...
           </xsl:when><!--Ending open arrow list-->
   	     <xsl:when test="parent::ul/@type='mdash' or parent::ul/@class='mdash' or parent::ul/@list-style-type='mdash'  or parent::ul/@type='mdash'" ><!--mdash list-->
         	  <MDL>
                   <xsl:if test="parent::*[@data-font-size]">
                        <xsl:attribute name="reduceFont" select="./parent::*[@data-font-size]/@data-font-size"/>
                   </xsl:if>
               ...
               <xsl:attribute name="aid:pstyle">
         			<xsl:choose>
         				<xsl:when test="not(preceding-sibling::li) and (following-sibling::li or child::ol or child::ul) and not(parent::*[1]/preceding-sibling::*[1][name()='jrnlHead1'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead2'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead3'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead4'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead5'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead6'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlRefHead'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlAckHead'])">
         				  <xsl:value-of select="$ancestorTbl"/>
         				  <xsl:value-of select="$subLevel"/>
         	            <xsl:text>MDL-T</xsl:text>		
         				</xsl:when>
                        <xsl:when test="preceding-sibling::li and not(following-sibling::li) and not(child::ul or child::ol)">
         				  <xsl:value-of select="$ancestorTbl"/>
         				  <xsl:value-of select="$subLevel"/>
                            <xsl:text>MDL-B</xsl:text>					
                            <xsl:if test="parent::*[1]/following-sibling::*[1][name()='jrnlHead1'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead2'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead3'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead4'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead5'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead6'] or parent::*[1]/following-sibling::*[1][name()='jrnlRefHead'] or parent::*[1]/following-sibling::*[1][name()='jrnlAckHead']">
                                <xsl:text>-BEFORE-HEAD</xsl:text>   
                            </xsl:if>                      
                            <xsl:if test="ancestor::div[@class='jrnlAbsGroup'] and count(./parent::ol/following-sibling::*)=0">
   	     ...
   	     <xsl:when test="parent::ul/@type='ndash' or parent::ul/@class='ndash' or parent::ul/@list-style-type='ndash'  or parent::ul/@type='ndash'" ><!--ndash list-->
         	  <MDL>
                   <xsl:if test="parent::*[@data-font-size]">
                        <xsl:attribute name="reduceFont" select="./parent::*[@data-font-size]/@data-font-size"/>
                   </xsl:if>
               ...
               <xsl:attribute name="aid:pstyle">
         			<xsl:choose>
         				<xsl:when test="not(preceding-sibling::li) and (following-sibling::li or child::ol or child::ul) and not(parent::*[1]/preceding-sibling::*[1][name()='jrnlHead1'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead2'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead3'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead4'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead5'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead6'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlRefHead'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlAckHead'])">
         				  <xsl:value-of select="$ancestorTbl"/>
         				  <xsl:value-of select="$subLevel"/>
         	            <xsl:text>NDL-T</xsl:text>		
         				</xsl:when>
                        <xsl:when test="preceding-sibling::li and not(following-sibling::li) and not(child::ul or child::ol)">
         				  <xsl:value-of select="$ancestorTbl"/>
         				  <xsl:value-of select="$subLevel"/>
                            <xsl:text>NDL-B</xsl:text>					
                            <xsl:if test="parent::*[1]/following-sibling::*[1][name()='jrnlHead1'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead2'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead3'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead4'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead5'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead6'] or parent::*[1]/following-sibling::*[1][name()='jrnlRefHead'] or parent::*[1]/following-sibling::*[1][name()='jrnlAckHead']">
                                <xsl:text>-BEFORE-HEAD</xsl:text>   
                            </xsl:if>                      
                            <xsl:if test="ancestor::div[@class='jrnlAbsGroup'] and count(./parent::ol/following-sibling::*)=0">
   	     ...
   	     <xsl:when test="parent::ul/@type='check-mark' or parent::ul/@class='check-mark' or parent::ul/@list-style-type='check-mark'  or parent::ul/@type='check-mark'" ><!--check-mark list-->
         	  <CML>
                   <xsl:if test="parent::*[@data-font-size]">
                        <xsl:attribute name="reduceFont" select="./parent::*[@data-font-size]/@data-font-size"/>
                   </xsl:if>
               ...
               <xsl:attribute name="aid:pstyle">
         			<xsl:choose>
         				<xsl:when test="not(preceding-sibling::li) and (following-sibling::li or child::ol or child::ul) and not(parent::*[1]/preceding-sibling::*[1][name()='jrnlHead1'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead2'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead3'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead4'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead5'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlHead6'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlRefHead'] or parent::*[1]/preceding-sibling::*[1][name()='jrnlAckHead'])">
         				  <xsl:value-of select="$ancestorTbl"/>
         				  <xsl:value-of select="$subLevel"/>
         	            <xsl:text>CML-T</xsl:text>		
         				</xsl:when>
                        <xsl:when test="preceding-sibling::li and not(following-sibling::li) and not(child::ul or child::ol)">
         				  <xsl:value-of select="$ancestorTbl"/>
         				  <xsl:value-of select="$subLevel"/>
                            <xsl:text>CML-B</xsl:text>					
                            <xsl:if test="parent::*[1]/following-sibling::*[1][name()='jrnlHead1'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead2'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead3'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead4'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead5'] or parent::*[1]/following-sibling::*[1][name()='jrnlHead6'] or parent::*[1]/following-sibling::*[1][name()='jrnlRefHead'] or parent::*[1]/following-sibling::*[1][name()='jrnlAckHead']">
                                <xsl:text>-BEFORE-HEAD</xsl:text>   
                            </xsl:if>                      
                            <xsl:if test="ancestor::div[@class='jrnlAbsGroup'] and count(./parent::ol/following-sibling::*)=0">
...
<!--
Changes should be done in xsl for 
1. Combine all template matches for float blocks
